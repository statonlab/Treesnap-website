    ...
    return (
      <div>
        ...
        <div className="tile is-ancestor">
            ...
            <div className="tile is-child card us-tile">
              <div className="card-image">
                <figure className="image face">
                  <img src="/images/us/mstaton-min.png" alt="Margaret Staton"/>
                </figure>
              </div>
            ...
            <div className="tile is-child card us-tile">
              <div className="card-image">
                <figure className="image">
                  <img src="/images/us/condon-min.jpg" alt="Bradford Condon"/>
                </figure>
              </div>
              <div className="card-content">
                <div className="media">
          ...
          <div className="tile is-parent">
            ...
            <div className="tile is-child card us-tile">
              <div className="card-image">
                <figure className="image">
                  <img src="/images/us/almsaeed-min.jpg" alt="Abdullah Almsaeed"/>
                </figure>
              </div>
              <div className="card-content">
                <div className="media">
        ...
        <div className="tile is-ancestor">
            ...
            <div className="tile is-child card us-tile">
              <div className="card-image">
                <figure className="image is-square">
                  <img src="/images/us/Nelson-min.jpg" alt="Dana Nelson"/>
                </figure>
              </div>
              <div className="card-content">
                <div className="media">
          ...
          <div className="tile is-parent">
            <div className="tile is-child card us-tile">
              <div className="card-image">
                <figure className="image is-square">
                  <img src="/images/us/abbott-min.jpg" alt="Bert Abbott"/>
                </figure>
              </div>
              <div className="card-content">
                <div className="media">
          ...
          <div className="tile is-parent">
            <div className="tile is-child card us-tile">
              <div className="card-image">
                <figure className="image is-square">
                  <img src="/images/us/crocker-min.jpg" alt="Ellen Crocker"/>
                </figure>
              </div>
              <div className="card-content">
                <div className="media">
        ...
        <div className="card">
          <div className="card-image">
            <figure className="image">
              <img src="/images/us/FHREC_photo.jpg" alt="FHERC Photo"/>
            </figure>
          </div>
          <div className="card-content">
            <div className="media">
