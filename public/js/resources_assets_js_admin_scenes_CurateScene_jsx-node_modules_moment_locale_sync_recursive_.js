(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_assets_js_admin_scenes_CurateScene_jsx-node_modules_moment_locale_sync_recursive_"],{
...
/***/ "./resources/assets/js/admin/scenes/CurateScene.jsx":
/*!**********************************************************!*\
  !*** ./resources/assets/js/admin/scenes/CurateScene.jsx ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CurateScene)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _components_ObservationCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/ObservationCard */ "./resources/assets/js/components/ObservationCard.jsx");
/* harmony import */ var _helpers_Path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../helpers/Path */ "./resources/assets/js/helpers/Path.js");
/* harmony import */ var _components_Spinner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/Spinner */ "./resources/assets/js/components/Spinner.jsx");
/* harmony import */ var _components_EmailModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/EmailModal */ "./resources/assets/js/admin/components/EmailModal.jsx");
...
var CurateScene = /*#__PURE__*/function (_Scene) {
  _inherits(CurateScene, _Scene);
  function CurateScene(props) {
    var _this;
    _classCallCheck(this, CurateScene);
    _this = _callSuper(this, CurateScene, [props]);
    _this.state = {
      observations: [],
      search: '',
  ...
  _createClass(CurateScene, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var page = this.getBrowserPage();
      this.loadObservations(Object.assign({}, this.state, {
        page: page
      }));
      this.loadUser();
      this.loadCategories();
    ...
    value: function loadObservations(state) {
      ...
      axios.get("/admin/web/curate/observations/".concat(state.perPage), {
        params: {
          page: state.page,
          search: state.search,
        ...
        var newState = {
          ...
          pages: _this2.generatePages(data.total, state.perPage),
          pageLoading: false
        };
        _this2.setState(newState);
        _this2.setBrowserHistory(newState);
      })["catch"](function (error) {
        _this2.setState({
          loading: false
        });
    ...
    value: function loadCategories() {
      ...
      axios.get('/web/observations/categories').then(function (response) {
        var categories = response.data.data.map(function (category) {
          return {
            label: category,
            value: category
          };
    ...
    key: "generatePages",
    value: function generatePages(total, perPage) {
      var pages = [];
    ...
    value: function setBrowserHistory(state) {
      this.props.history.replace("/curate/?page=".concat(state.currentPage));
    }
    ...
    value: function getBrowserPage() {
      var params = _helpers_Path__WEBPACK_IMPORTED_MODULE_2__["default"].parseUrl(this.props.history.location.search);
    ...
    key: "changeCategory",
    value: function changeCategory(selectedCategory) {
      this.setState({
    ...
    key: "changeStatus",
    value: function changeStatus(selectedStatus) {
      this.setState({
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("input", {
                ...
                onChange: function onChange(_ref) {
                  var target = _ref.target;
                  return _this5.searchFilter(target.value);
                },
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("select", {
                  ...
                  onChange: function onChange(_ref2) {
                    var target = _ref2.target;
                    return _this5.changeStatus(target.value);
                  },
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("option", {
                    value: 0,
                    children: "Any Status"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("option", {
                    value: 'marked_correct_by_anyone',
                    children: "Species marked correct by anyone"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("option", {
                    value: 'marked_correct_by_me',
                    children: "Species marked correct by me"
                  })]
                })
              })
            })
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("select", {
                  ...
                  onChange: function onChange(_ref3) {
                    var target = _ref3.target;
                    return _this5.changeCategory(target.value);
                  },
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("option", {
                    value: 0,
                    children: "Any Species"
    ...
    value: function _renderObservation(observation) {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_ObservationCard__WEBPACK_IMPORTED_MODULE_1__["default"], {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("nav", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("a", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("li", {
            children: ["Page ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
              className: "select is-small",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("select", {
                value: this.state.currentPage,
                onChange: function onChange(_ref4) {
                  var target = _ref4.target;
                  return _this8.goToPage(target.value);
                },
    ...
    value: function render() {
      var _this9 = this;
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_3__["default"], {
          visible: this.state.pageLoading
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_EmailModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
          ...
          children: "Curate Observations"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          className: "columns flex-v-center mb-none",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
            className: "column",
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("p", {
              children: [this.state.total, " total observations. Showing", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
                className: "select is-small ml-0 mr-0",
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("select", {
                  value: this.state.perPage,
                  onChange: function onChange(_ref5) {
                    var target = _ref5.target;
                    return _this9.changePerPage(target.value);
                  },
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("option", {
                    value: 3,
                    children: "3"
        ...
        }), this._renderFilters(), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          className: "columns is-multiline",
          children: [this.state.observations.length === 0 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("p", {
            children: "No results found"
          }) : null, this.state.observations.map(this._renderObservation.bind(this))]
