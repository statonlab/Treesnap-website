...
var SamplingProjectScene = function (_Scene) {
  _inherits(SamplingProjectScene, _Scene);

  function SamplingProjectScene(props) {
    _classCallCheck(this, SamplingProjectScene);

    var _this = _possibleConstructorReturn(this, (SamplingProjectScene.__proto__ || Object.getPrototypeOf(SamplingProjectScene)).call(this, props));
  ...
  _createClass(SamplingProjectScene, [{
    ...
    value: function loadProject() {
      ...
      axios.get('/web/sampling-project/' + id).then(function (response) {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { className: 'input mb-1',
              onChange: function onChange(e) {
                _this3.setState({ participant: e.target.value });
              } }),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              'button',
              { className: 'button is-primary',
                onClick: function onClick() {
                  return _this3.addParticipant();
                } },
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'span',
                null,
  ...
  return SamplingProjectScene;
}(__WEBPACK_IMPORTED_MODULE_1__Scene__["a" /* default */]);

/* harmony default export */ __webpack_exports__["default"] = (SamplingProjectScene);
