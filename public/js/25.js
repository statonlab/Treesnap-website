...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Dropdown__ = __webpack_require__(457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Spinner__ = __webpack_require__(426);
...
var FlagsScene = function (_Component) {
  _inherits(FlagsScene, _Component);
  ...
  _createClass(FlagsScene, [{
    ...
    value: function next() {
      ...
      this.setState({
        ...
        console.log('going to page: ', _this4.state);
        _this4.loadFlags();
      });
    }
  }, {
