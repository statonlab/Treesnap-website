(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_assets_js_scenes_ObservationScene_jsx-node_modules_moment_locale_sync_recursive_-_5-16f5800"],{
...
/***/ "./resources/assets/js/scenes/ObservationScene.jsx":
/*!*********************************************************!*\
  !*** ./resources/assets/js/scenes/ObservationScene.jsx ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ObservationScene)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
...
/* harmony import */ var _components_ObservationDetails__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/ObservationDetails */ "./resources/assets/js/components/ObservationDetails.jsx");
...
/* harmony import */ var _helpers_EventEmitter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../helpers/EventEmitter */ "./resources/assets/js/helpers/EventEmitter.js");
...
var ObservationScene = /*#__PURE__*/function (_Scene) {
  _inherits(ObservationScene, _Scene);
  function ObservationScene(props) {
    var _this;
    _classCallCheck(this, ObservationScene);
    _this = _callSuper(this, ObservationScene, [props]);
    _this.state = {
      loading: false,
      observation: null,
      updatingNote: false,
  ...
  _createClass(ObservationScene, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var id = this.props.match.params.id;
      this.loadObservation(id);
      this.loadNotes(id);
      _helpers_EventEmitter__WEBPACK_IMPORTED_MODULE_8__["default"].listen('observation_deleted', this.observationDeleted.bind(this));
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
    ...
    key: "observationDeleted",
    value: function observationDeleted() {
      this.setState({
        deleted: true
      });
    }
    ...
    key: "loadObservation",
    value: function loadObservation(id) {
      var _this2 = this;
      this.setState({
        loading: true
      });
      axios.get("/web/observation/".concat(id)).then(function (response) {
        var data = response.data.data;
        _this2.setState({
          observation: data,
          loading: false
        });
        var name = data.observation_category.toLowerCase() === 'other' ? "Other: ".concat(data.meta_data.otherLabel) : data.observation_category;
        document.title = "".concat(name, " (").concat(data.observation_id, ") | TreeSnap");
      })["catch"](function (error) {
        _this2.setState({
          loading: false
        });
    ...
    key: "loadNotes",
    value: function loadNotes(observation_id) {
      var _this3 = this;
      if (!_helpers_User__WEBPACK_IMPORTED_MODULE_7__["default"].authenticated()) {
        return;
      }
      axios.get("/web/note/".concat(observation_id)).then(function (response) {
    ...
    value: function saveNote(e) {
      ...
      var observation_id = this.state.observation.observation_id;
      var note = this.state.note;
      axios.post('/web/notes', {
        ...
        if (data.created) {
          _components_Notify__WEBPACK_IMPORTED_MODULE_5__["default"].push('Note saved successfully');
        }
        if (data.deleted) {
          _components_Notify__WEBPACK_IMPORTED_MODULE_5__["default"].push('Note was deleted successfully', 'warning');
        }
      })["catch"](function (error) {
        var response = error.response;
        if (response && response.status === 422) {
    ...
    key: "detachCollection",
    value: function detachCollection(collection) {
      var _this5 = this;
      axios["delete"]('/web/collection/detach', {
        ...
        _components_Notify__WEBPACK_IMPORTED_MODULE_5__["default"].push("Observation removed from \"".concat(collection.label, "\" successfully"));
        var observation = _this5.state.observation;
    ...
    key: "detachFlag",
    value: function detachFlag(flag) {
      var _this6 = this;
      axios["delete"]("/web/flag/".concat(flag.id)).then(function (response) {
        _components_Notify__WEBPACK_IMPORTED_MODULE_5__["default"].push('Flag deleted successfully');
        var observation = _this6.state.observation;
        observation.flags = observation.flags.filter(function (f) {
          return f.id !== flag.id;
        });
        _this6.setState({
          observation: observation
    ...
    key: "_renderMetaView",
    value: function _renderMetaView(observation) {
      var _this7 = this;
      if (!_helpers_User__WEBPACK_IMPORTED_MODULE_7__["default"].authenticated()) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("p", {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("a", {
              href: "/login",
              children: "Login"
            }), " or ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("a", {
              href: "/register",
              children: "register a new account"
            }), " to create collections, flag observations or add private notes to an observation."]
          })
        });
      }
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                  ...
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("textarea", {
                    className: "textarea".concat(this.state.errors.note.length > 0 ? ' is-danger' : ''),
                ...
                }), this.state.errors.note.map(function (error, index) {
                  ...
                  className: "help",
                  children: "You may add private notes to this observation by filling the text box above."
                })]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
                className: "field",
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                  className: "control is-flex flex-v-center flex-space-between",
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("button", {
                    type: "submit",
                    className: "button is-primary".concat(this.state.updatingNote ? ' is-loading' : ''),
                    disabled: this.state.updatingNote,
                    children: "Save"
                  }), this.state.noteSavedAt !== null ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("p", {
                    className: "help",
                    children: ["Last updated at ", moment__WEBPACK_IMPORTED_MODULE_6___default()(this.state.noteSavedAt.date).format('LLL')]
                  }) : null]
                })
              })]
            })]
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("h4", {
              className: "title is-5",
              children: "Collections"
            }), observation.collections.length === 0 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("p", {
              children: "You have not added this observation to any collections yet."
            }) : null, observation.collections.map(function (collection) {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                className: "flexbox flex-space-between",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("p", {
                  ...
                  onClick: function onClick() {
                    return _this7.detachCollection(collection);
                  },
                  children: "Remove"
                })]
              }, collection.id);
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("h4", {
              className: "title is-5",
              children: "Flags"
            }), observation.flags.length === 0 ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("p", {
              children: "You have not flagged this observation."
            }) : null, observation.flags.map(function (flag) {
              return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                className: "flexbox flex-space-between",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("p", {
                    children: ["You have flagged this observation as: \"", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("b", {
    ...
    key: "_renderContent",
    value: function _renderContent(observation) {
      var _this8 = this;
      if (observation === null) {
        return null;
      }
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_ObservationDetails__WEBPACK_IMPORTED_MODULE_4__["default"], {
          observation: observation,
          showControls: true,
          onAddedToCollection: function onAddedToCollection(collection) {
            var observation = _this8.state.observation;
          ...
          onFlagCreated: function onFlagCreated(flag) {
            var observation = _this8.state.observation;
            var exists = !observation.flags.every(function (f) {
              return f.id !== flag.id;
            });
            if (!exists) {
    ...
    value: function render() {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
        children: [this.props.admin ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"], {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_3__["default"], {
          visible: this.state.loading
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
          className: "home-section short-content",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
            className: this.props.admin ? '' : 'container',
            children: this._renderContent(this.state.observation)
          })
        }), this.props.admin ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_HomeFooter__WEBPACK_IMPORTED_MODULE_2__["default"], {})]
      });
    }
  }]);
...
ObservationScene.propTypes = {
  admin: (prop_types__WEBPACK_IMPORTED_MODULE_11___default().bool)
};
